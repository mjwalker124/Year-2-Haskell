...
-- TEST2
 ...
 --enigmaEncodeMessage "RCQRSVHNYQHLVKLELFYSYCCLMKHUFXMVYVREFLHZOLRCBRHWPQDUONZWOGRTYKAUW" (SteckeredEnigma rotor1 rotor2 rotor3 reflectorB [('M','P'),('U','A'),('V','B'),('L','O'),('H','R'),('S','D'),('F','K'),('E','C'),('T','G')]) (0,0,5)
 ...
 -- the encoded message is
 --     ZUBUSNBOIIEHVWAECJOIZWSAEIGNFTWJENWAQBMVTISYGYJDXNJQGODKBUUKEH
 --     TURINGBOMBEHASKELLSIMULATIONSTOP
 c3= "FNWGDVEHEHJXCGOTOHQLELJOAGABOIDLXIGKFISZUZCAQNUWKXUMSWTYMBIDZF"

-- FNWGDVEHEHJXCGOTOHQLELJOAGABOIDLXIGKFISZUZCAQNUWKXUMSWTYMBIDZF
